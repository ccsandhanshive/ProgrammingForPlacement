...
import {Problem1} from '../add-problem-statement/problemClass';
...
export class AddProblemStatementService {
  private problemUrl = 'http://localhost:3000/Temp-Problem';
  // constructor(private http: HttpClient) { }
  addProblem (problem:Problem): Observable<Problem> {
    return this.http.post<Problem>(this.problemUrl,problem, Headeroption);
  }
